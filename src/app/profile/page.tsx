          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
             ...
             <div className="bg-black/50 border border-white/5 p-5 rounded-3xl flex flex-col justify-between">
                ...
                <div className="flex items-end gap-1">
                   <span className="text-2xl font-black text-white">{Math.min(85, Math.max(15, userData.auraScore ?? 20))}</span>
                ...
                <div className="w-full h-1 bg-zinc-800/80 rounded-full mt-2 overflow-hidden">
                   <motion.div 
                     initial={{ width: 0 }}
                     animate={{ width: `${Math.min(85, Math.max(15, userData.auraScore ?? 20))}%` }}
