      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center p-4 overflow-hidden">
        ...
        <motion.div style={{ y: yBg, opacity: opacityText }} className="text-center w-full max-w-7xl mt-20 z-10 relative">
          ...
          <motion.h1 
            ...
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black leading-tight tracking-[0.1em] sm:tracking-[0.2em] mb-8 flex justify-center flex-nowrap whitespace-nowrap w-full overflow-hidden sm:overflow-visible"
          >
